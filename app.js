  ...
  return (
    <div className="px-4">
      ...
      <section id="photography" className="py-12 text-center fade-up">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <img src="photo1.jpg" alt="Wildlife 1" className="photo-img"/>
          <img src="photo2.jpg" alt="Wildlife 2" className="photo-img"/>
          <img src="photo3.jpg" alt="Wildlife 3" className="photo-img"/>
        </div>
      </section>
